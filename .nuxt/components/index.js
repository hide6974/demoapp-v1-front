...
export { default as LoggedInUiBreadcrumbs } from '../../components/loggedIn/ui/breadcrumbs.vue'
...
export const LazyLoggedInUiBreadcrumbs = import('../../components/loggedIn/ui/breadcrumbs.vue' /* webpackChunkName: "components/logged-in-ui-breadcrumbs" */).then(c => wrapFunctional(c.default || c))
